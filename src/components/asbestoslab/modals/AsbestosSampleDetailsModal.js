          ...
          {job &&
            ...
            (modalType === ASBESTOS_SAMPLE_DETAILS ||
              ...
              >
                  ...
                  <DialogContent>
                    <Grid container alignItems="flex-start" justify="flex-end">
                      <Grid item xs={6}>
                        ...
                        <div className={classes.informationBox}>
                          ...
                          {sample.layers &&
                            Object.keys(collateLayeredResults(sample.layers))
                              .length > 0 && (
                              <div
                                style={{
                                  display: "flex",
                          ...
                          {sample.confirm &&
                            Object.keys(sample.confirm).map((key) => {
                              if (
                                sample.confirm[key] !== undefined &&
                                sample.confirm[key] !== undefined &&
                                sample.confirm[key].deleted !== true &&
                                sample.confirm[key].analyst !== undefined
                              ) {
                      ...
                      <Grid item xs={6}>
                        <div className={classes.informationBox}>
                          ...
                          {sample.layers &&
                            ((sample.layers[`layer1`] !== undefined &&
                              Object.keys(sample.layers[`layer1`].result)
                                .length > 0) ||
                              (sample.layers[`layer2`] !== undefined &&
                                Object.keys(sample.layers[`layer2`].result)
                                  .length > 0) ||
                              (sample.layers[`layer3`] !== undefined &&
                    ...
                    {job.waAnalysis && (
                      <div className={classes.informationBox}>
                        ...
                        <AsbestosSampleWASummary
                          sample={sample}
                          noEdit
                          moisture={sampleMoisture}
                          acmInSoilLimit={
                            job.acmInSoilLimit
                              ? parseFloat(job.acmInSoilLimit)
                              : 0.01
                          }
                        />
                      </div>
                ...
                <DialogActions>
                  {(!modalPropsSecondary ||
                    modalPropsSecondary.noNext === undefined) && (
                    <span>
                      <Button
                        onClick={() => this.previousSample(samples)}
                        color="inherit"
                        disabled={samples[0].uid == sample.uid}
                      >
                        Previous
                      </Button>
                      <Button
                        onClick={() => this.nextSample(samples)}
                        color="secondary"
                        disabled={samples[samples.length - 1].uid == sample.uid}
                      >
                        Next
                      </Button>
                    </span>
      ...
      >
        <div
          style={{
            ...
            height: 40,
            borderRadius: 20,
            backgroundColor: `rgba(${layer.color ? layer.color.r : null}, ${
              layer.color ? layer.color.g : null
            }, ${layer.color ? layer.color.b : null}, ${
