  ...
  return (
    <Card className={classes.card}>
      ...
      <CardContent>
        ...
        <Typography className={classes.details}>
          <b>Date Acquired: </b><FormattedDate value={props.attr.date_acquired} year='numeric' month='long' day='2-digit' />
        </Typography>}
        {props.attr.date_expires &&
        <Typography className={classes.details}>
          <b>Expiry Date: </b><FormattedDate value={props.attr.date_expires} year='numeric' month='long' day='2-digit' />
        </Typography>}
      </CardContent>
    </Card>
  )
