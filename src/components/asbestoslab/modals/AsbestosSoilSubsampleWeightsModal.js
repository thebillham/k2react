...
import { ASBESTOS_SOIL_SUBSAMPLE_WEIGHTS } from "../../../constants/modal-types";
...
class AsbestosSoilSubsampleWeightsModal extends React.PureComponent {
  ...
  render() {
    ...
    if (modalType === ASBESTOS_SOIL_SUBSAMPLE_WEIGHTS) {
      return (
      <Dialog
        maxWidth="sm"
        style={{minHeight: 600}}
        scroll="body"
        fullWidth={true}
        open={modalType === ASBESTOS_SOIL_SUBSAMPLE_WEIGHTS}
...
export default withStyles(styles)(
  connect(
    mapStateToProps,
    mapDispatchToProps
  )(AsbestosSoilSubsampleWeightsModal)
);
