...
const dummyList = [
  ...
  },
  {
    type: "training",
    text:
      'John Doe has completed all required readings for training module "Asbestos Clearances"'
  },
  {
    type: "training",
  ...
  },
  {
    type: "analysis",
    text:
      "Results have been reported for asbestos job AS181818 (Morgan Project Services)"
  },
  {
    type: "general",
          ...
          return (
            <div key={not.text}>
              <div className={classes.notifications}>
                {not.type === "training" && (
                  <TrainingIcon className={classes.notificationIcon} />
                )}
                {not.type === "analysis" && (
                  <AnalysisIcon className={classes.notificationIcon} />
                )}
                {not.type === "urgent" && (
                  <NotificationIcon
                    className={classes.notificationIconUrgent}
                  />
                )}
                {not.type === "general" && (
