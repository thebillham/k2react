...
class SiteAddAcm extends React.Component {
  ...
  render() {
    ...
    if (m) {
      ...
      return (
        <DragDropContext onDragEnd={this.onDragEnd} className={classes.marginTopStandard}>
  ...
  getAcmCard = item => {
    ...
    return (
      <div className={classes.flexRowSpread}>
        ...
        <div className={classes.flexRow}>
          <IconButton>
            {item.checkKTP ? <CheckKTPIcon className={classes.colorsOk} /> : item.checkChecker ? <CheckCheckerIcon className={classes.colorsOk} /> : item.checkWriter ? <CheckWriterIcon className={classes.colorsOk} /> : <NotCheckedIcon className={classes.colorsWarning} />}
          </IconButton>
          <IconButton>
            {item.sampleType === 'air' ?
