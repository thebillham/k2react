...
class UpdateMethodVersion extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      change: {
            ...
            <FormControlLabel
              control={
                <Checkbox
                  ...
                  onChange={e => this.setState({ newVersion: e.target.checked })}
                  value="enabled"
                />}
...
export default withStyles(modalStyles)(connect(mapStateToProps, mapDispatchToProps)(UpdateMethodVersion));
