...
class Method extends React.Component {
  ...
  componentDidMount() {
    let step = 0;
    if (this.props.steppers[this.props.match.params.uid])
      step = this.props.steppers[this.props.match.params.uid];
      ...
      <div style={{ marginTop: 80 }}>
        {this.state.isLoading ? (
          ...
          <div>
            ...
            >
              <div
                style={{ fontSize: 26, fontWeight: 600, color: "#004c2f" }}
                dangerouslySetInnerHTML={{
                  __html:
                    method.steps[activeStep] && method.steps[activeStep].content
                }}
              />
            </Paper>
          </div>
