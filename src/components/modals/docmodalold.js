...
function DocumentModal(props) {
  return (
    ...
    >
        ...
        <form>
          <FormGroup>
            <TextField
              ...
              onChange={e => {
                store.dispatch(handleModalChange(e.target));
              }}
            />
            <TextField
              id="desc"
            ...
            <div>
              <ReactTags
                ...
                handleDelete={i => {
                  store.dispatch(handleTagDelete(i));
                }}
                handleAddition={tag => {
                  store.dispatch(handleTagAddition(tag));
                }}
            ...
            <label>
              ...
              <LinearProgress
                variant="determinate"
                value={props.modalProps.uploadProgress}
              />
            </label>
          </FormGroup>
        </form>
      ...
      <DialogActions>
        <Button onClick={() => store.dispatch(hideModal)} color="secondary">
          Cancel
        </Button>
        {props.modalProps.isUploading ? (
