...
function AsbestoSampleListAir(props) {
  ...
  (
    <div className={classNames(classes.paddingTopBottomSmall, classes.flexRowHover)} key={i}>
        ...
        <div className={classNames(classes.paddingSidesSmall, classes.columnMed)}>
          <SuggestionField that={that} suggestions='airLocationSuggestions'
        ...
        <div className={classes.columnSmall}>
          <TextField
            ...
            onChange={e => {
              that.setState({ modified: true, });
              that.props.handleSampleChange(i, {initialFlowRate: numericOnly(e.target.value.trim())});
            }}
          />
        </div>
        <div className={classes.spacerSmall} />
        <div className={classes.columnSmall}>
          <TextField
            ...
            onChange={e => {
              that.setState({ modified: true, });
              that.props.handleSampleChange(i, {finalFlowRate: numericOnly(e.target.value.trim())});
            }}
          />
        </div>
        <div className={classes.spacerSmall} />
        ...
        <div className={classes.columnMedSmall}>
          <DateTimePicker
            ...
            onChange={date => {
              that.setState({ modified: true, });
              that.props.handleSampleChange(i, {endTime: dateOf(date), totalRunTime: null, });
            }}
          />
        </div>
        <div className={classes.spacerSmall} />
        <div className={classes.columnMedSmall}>
          <TextField
            ...
            onChange={e => {
              that.setState({ modified: true, });
              that.props.handleSampleChange(i, {totalRunTime: numericOnly(e.target.value.trim())});
            }}
          />
        </div>
        <div className={classes.spacerSmall} />
        ...
        {doc.historicalCoc && <div className={classes.columnSmall}>
          <TextField
            ...
            onChange={e => {
              that.setState({ modified: true, });
              that.props.handleSampleChange(i, {fibreResult: numericOnly(e.target.value.trim())});
            }}
          />
        </div>}
        {doc.historicalCoc && <div className={classes.columnSmall} />}
  ...
  : sampleType === "air" ?
    (<div className={disabled ? classes.flexRowHoverDisabled : classes.flexRowHover} key={i}>
      ...
      {doc.historicalCoc && <div className={classes.columnSmall}>
      {calcs.reportConcentration ? <div className={calcs.reportConcentration.includes("<") ? classes.informationBoxOk : calcs.informationBoxError}>
