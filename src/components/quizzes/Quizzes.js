    ...
    return (
      <div style = {{ marginTop: 80 }}>
        ...
        { this.props.me.auth['Quiz Editor'] &&
          <Button variant='outlined' style={{ marginBottom: 16, }} onClick={() => {this.props.showModal({ modalType: QUIZ, modalProps: { title: 'Add New Quiz', doc: { numberofquestions: 1, optional: [], required: [], } } })}}>
            Add New Quiz
          </Button>
        }
        <Button variant='outlined' style={{ marginLeft: 16, marginBottom: 16, }} onClick={() => {this.props.history.push('../questions/')}}>
          See All Questions
        </Button>
              ...
              <div key={doc.uid}>
                <QuizList quiz={doc}
                  showModal={() => {
                      ...
                      this.props.showModal({ modalType: QUIZ, modalProps: { title: 'Edit Quiz', doc: doc, } });
                    }}
                  deleteQuiz={() => {
                    if (window.confirm(`Are you sure you wish to delete the quiz '${doc.title}'?`))
